...
function displayWomen(shopWomen) {

    var table = document.getElementById("shirtBody");

    table.innerHTML = "";
    totalWomenProducts = product_array.length;
    for (var count = 0; count < totalWomenProducts; count++) {
        if (product_array[count].productCategory == shopWomen) {
            ...
            var cell =
                ...
                '<div class="tshirtTile">'+
                    '<img item=' + count + ' src="' + thumbnail + '" style="width:350px; height:400px;"/>'+
